...
const Login = ()=>{
    ...
    const setErrorHandler = (a,b)=>{
       ...
       const setLoginValues =(status, login, detail)=>{
           setAuthenticated(status)
           setLoginDetail(login, detail)
           ...
           if(!formData.emailOrUsername || !formData.password){
            ...
            let password = formData.password
               ...
               if(password.length < 8){
                ...
                const options = {
                url : 'https://investapp3.herokuapp.com/api/v1/auth/login',
                method: 'POST',
                headers: {
                ...
                .then(result =>{
                    ...
                    if(response == "success"){
                        setLoginValues(true, emailOrUsername, data)
