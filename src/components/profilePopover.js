...
export default function ProfilePopover() {
  ...
  const {setAuthenticated, setLoginDetail, userVerified, userCreated, userDetail} = UseContext()
  ...
  return (
    <div className={classes.main}>
      ...
      >
         ...
         {!userCreated && ! userVerified ?
            <Link to='/createuser'  className={classes.dashboardLink}><DashboardButton>create user Profile</DashboardButton></Link>
          : userCreated && ! userVerified ?
            <Link to='/verifyPhone'  className={classes.dashboardLink}><DashboardButton>Verify phone number</DashboardButton></Link>
          :
         <>
